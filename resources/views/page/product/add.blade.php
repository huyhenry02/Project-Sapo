            ...
            <div class="row">
                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="productNameLabel" placeholder="Sản phẩm ..." aria-label="Shirt, t-shirts, etc.">
                            </div>
                            <!-- End Form Group -->
                            <div class="row">
                                <div class="col-sm-12">
                    ...
                    <div class="card">
                      ...
                      "defaultCreated": 0
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="js-select2-custom custom-select" size="1" style="opacity: 0;" name="attribute_value_id" id="colorLabel" data-hs-select2-options='{
                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="price" id="priceNameLabel" placeholder="VND" aria-label="0.00">
                  ...
                  <span class="col-8 col-sm-9 toggle-switch-content">
                    ...
                    <input type="checkbox" class="toggle-switch-input" id="availabilitySwitch1" value="1" name="availability" required>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom custom-select" size="1" style="opacity: 0;" name="vendor_id" id="vendorLabel" data-hs-select2-options='{
                            "minimumResultsForSearch": "Infinity",
                            ...
                            <div class="form-group">
                                ...
                                <!-- Select -->
                                <select class="js-select2-custom custom-select" size="1" style="opacity: 0;" id="categoryLabel" name="category_id" data-hs-select2-options='{
                            "minimumResultsForSearch": "Infinity",
                            ...
                            <div class="form-group">
                                ...
                                <!-- Select -->
                                <select class="js-select2-custom custom-select" size="1" style="opacity: 0;" id="brandLabel" name="brand_id" data-hs-select2-options='{
                            "minimumResultsForSearch": "Infinity",
                ...
                <div class=" bottom-0 content-centered-x w-100 z-index-99 mb-3" style="max-width: 40rem;">
                    <!-- Card -->
