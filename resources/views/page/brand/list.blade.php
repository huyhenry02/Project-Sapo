                    ...
                    <div class="col-sm mb-2 mb-sm-0">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-no-gutter">
                                ...
                                <li class="breadcrumb-item"><a class="breadcrumb-link" href="javascript:;">Thương hiệu</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Danh sách</li>
                            </ol>
                        </nav>

                        <h1 class="page-header-title">Thương hiệu</h1>
                    </div>
            ...
            <div class="row gx-2 gx-lg-3">
                <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <h6 class="card-subtitle mb-2">Tổng số thương hiệu</h6>

                            <div class="row align-items-center gx-2">
                                <div class="col">
                                    <span class="js-counter display-4 text-dark">{{$brandCount}}</span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-center gx-2">
                                <div class="col">
                                    ...
                                    <span class="text-body font-size-sm ml-1">từ {{$brandCount}}</span>
                                </div>
                                <div class="col-auto">
                                    <span class="badge badge-soft-success p-1">
