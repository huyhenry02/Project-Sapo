                    ...
                    <div class="col-sm mb-2 mb-sm-0">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-no-gutter">
                                ...
                                <li class="breadcrumb-item"><a class="breadcrumb-link" href="javascript:;">Danh mục sản phẩm</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Danh sách</li>
                            </ol>
                        </nav>

                        <h1 class="page-header-title">Danh mục sản phẩm</h1>
                    </div>

                    <div class="col-sm-auto">
                        <a class="btn btn-primary" href="{{route('show_add_category.index')}}">
                            <i class="tio-user-add mr-1"></i> Thêm danh mục sản phẩm
                        </a>
                    </div>
                </div>
                <!-- End Row -->
            ...
            <div class="row gx-2 gx-lg-3">
                <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <h6 class="card-subtitle mb-2">Tổng số danh mục sản phẩm</h6>

                            <div class="row align-items-center gx-2">
                                <div class="col">
                                    <span class="js-counter display-4 text-dark">{{$categoryCount}}</span>
                ...
                <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <h6 class="card-subtitle mb-2">Thương hiệu đang hoạt động</h6>

                            <div class="row align-items-center gx-2">
                                <div class="col">
                                    <span class="js-counter display-4 text-dark">{{$activeBrandCount}}</span>
                                    <span class="text-body font-size-sm ml-1">từ {{$categoryCount}}</span>
                                </div>
                                <div class="col-auto">
                                    <span class="badge badge-soft-success p-1">
                    ...
                    @foreach($category as $key=>$val)
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-sm btn-white" href="{{route('category.delete',$val->id)}}" >
